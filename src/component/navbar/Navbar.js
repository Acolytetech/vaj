...
//                       <li className="mb-2" onClick={handleClose()} ><Link to="/Bitumen" className="hover:text-gray-300">Bitumen</Link></li>
//                       <li className="mb-2" onClick={handleClose()}><Link to="/Ca-solvent" className="hover:text-gray-300">CA Solvent</Link></li>
//                       <li className="mb-2" onClick={handleClose()}><Link to="/Furnance-oil" className="hover:text-gray-300">Furnace Oil</Link></li>
//                       <li className="mb-2" onClick={handleClose()}><Link to="/Fuel-oil" className="hover:text-gray-300">Fuel Oil</Link></li>
//                       <li className="mb-2" onClick={handleClose()}><Link to="/Light-diesel-oil" className="hover:text-gray-300">Light Diesel Oil (LDO)</Link></li>
//                       <li className="mb-2" onClick={handleClose()}><Link to="/Mineral-turpentine-oil" className="hover:text-gray-300">Mineral Turpentine Oil (MTO)</Link></li>
//                       <li className="mb-2" onClick={handleClose()}><Link to="/Rubber-processing-oil" className="hover:text-gray-300">Rubber Processing Oil</Link></li>
//                     </ul>
//                     <ul className="mega-links">
//                       <li className="mb-2"onClick={handleClose()} ><Link to="/base-fuel" className="hover:text-gray-300">Base Oil</Link></li>
//                       <li className="mb-2"onClick={handleClose()} ><Link to="/import-diesel" className="hover:text-gray-300">Import Diesel</Link></li>
//                       <li className="mb-2" onClick={handleClose()}><Link to="/bio-diesel" className="hover:text-gray-300">Bio Diesel</Link></li>
//                       <li className="mb-2" onClick={handleClose()}><Link to="/indian-coal" className="hover:text-gray-300">Indian Coal</Link></li>
//                       <li className="mb-2"onClick={handleClose()} ><Link to="/C9-solvent" className="hover:text-gray-300">C9 Solvent</Link></li>
//                       <li className="mb-2" onClick={handleClose()}><Link to="/Toluene" className="hover:text-gray-300">Toluene</Link></li>
//                       <li className="mb-2" onClick={handleClose()}><Link to="/Benzene" className="hover:text-gray-300">Benzene</Link></li>
//                     </ul>
//                     <ul className="mega-links">
//                       <li className="mb-2" onClick={handleClose()}><Link to="/glycol-ethers"  className="hover:text-gray-300">Glycol Ethers</Link></li>
//                       <li className="mb-2" onClick={handleClose()}><Link to="/Mixed-hydrocarbon-oil"  className="hover:text-gray-300">Mixed Hydrocarbon Oil</Link></li>
//                       <li className="mb-2" onClick={handleClose()}><Link to="/ketones"  className="hover:text-gray-300">Ketones</Link></li>
//                       <li className="mb-2" onClick={handleClose()}><Link to="/methyle-alcohol"  className="hover:text-gray-300">Methyle Alcohol</Link></li>
//                       <li className="mb-2"onClick={handleClose()} ><Link to="/phenols"  className="hover:text-gray-300">Phenols</Link></li>
//                       <li className="mb-2" onClick={handleClose()}><Link to="/xylene"  className="hover:text-gray-300">Xylene</Link></li>
//                       <li className="mb-2" onClick={handleClose()}><Link to="/n-hexane"  className="hover:text-gray-300">N-Hexane</Link></li>
//                     </ul>
//                     <ul className="mega-links">
//                       <li className="mb-2" onClick={handleClose()}><Link to="/Lime-stone" className="hover:text-gray-300">Lime Stone & Cement Grade</Link></li>
//                       <li className="mb-2" onClick={handleClose()}><Link to="/gypsum"  className="hover:text-gray-300">Gypsum</Link></li>
//                       <li className="mb-2"onClick={handleClose()} ><Link to="/pyroxenite"  className="hover:text-gray-300">Pyroxenite</Link></li>
//                       <li className="mb-2" onClick={handleClose()}><Link to="/recyling-oil" className="hover:text-gray-300">Recycling Oil</Link></li>
//                       <li className="mb-2"onClick={handleClose()} ><Link to="/tyre-oil"  className="hover:text-gray-300">Tyre Oil</Link></li>
//                       <li className="mb-2" onClick={handleClose()}><Link to="/industrial-oil"  className="hover:text-gray-300">Industrial Oils</Link></li>
//                       <li className="mb-2" onClick={handleClose()}><Link to="/chrome-ore"  className="hover:text-gray-300">Chrome Ore</Link></li>
//                       <li className="mb-2" onClick={handleClose()}><Link to="/manganese-ore"  className="hover:text-gray-300">Manganese Ore</Link></li>
//                     </ul>
//                   </div>
//                 </div>
//               </div>
