      ...
      <div className="flex flex-col md:flex-row bg-white  overflow-hidden">
        <div className="md:w-2/2 p-6 flex flex-col justify-center">
          ...
          <p className="text-gray-700 mb-4">
            ...
            The terms V10, V20, V30, and V40 usually relate to bitumen's viscosity grades, which specify its particular usage in various applications.

            <ul className='mt-3'>
              <li>
                <strong>VARITIES:-</strong>
                <ul style={{
                  listStyle: 'disc', paddingLeft:'20px', display:'flex', gap:'100px'
                }}>
                  <li>V10</li>
                  <li>V20</li>
                  <li>V30</li>
