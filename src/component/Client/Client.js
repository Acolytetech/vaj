  ...
  return (
    <div className="client">
      <div className="client-container" data-aos="fade-right">
        <h1 className="text-3xl md:text-5xl font-bold mb-2 leading-relaxed p-5 text-white">
          Serving Impressive List Of Long Term Clients!
        </h1>
        <p className="text-base md:text-xl lg:text-2xl text-white mb-4 py-8 font-medium leading-relaxed p-5">
