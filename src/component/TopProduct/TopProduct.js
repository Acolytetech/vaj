  ...
  return (
    <div className="fixed-bg">
      <div className="content-container" data-aos="fade-left">
        <h2 className="text-2xl md:text-2xl lg:text-5xl font-bold mb-2 leading-relaxed pr-8 p-5" data-aos="fade-right">
          Top Petroleum Product Supplier Of India
        </h2>
        <p className="text-base md:text-base lg:text-2xl text-black mb-4 py-8 font-medium leading-relaxed p-5" data-aos="fade-left">
        ...
        <div className='flex flex-col md:flex-row justify-between p-5' data-aos="fade-right">
          <ul className='p-5'>
            <li className="text-base md:text-lg lg:text-xl text-black font-medium flex items-center pr-8">
